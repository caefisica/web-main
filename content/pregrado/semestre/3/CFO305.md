...
{{< details "Vectores en $\\mathbb{R}^n$" >}}
...
*Definición de Vector*: Los **vectores** son objetos matemáticos que tienen _módulo, dirección y sentido_. Se puede representar gráficamente a cualquier **vector** mediante una flecha.
