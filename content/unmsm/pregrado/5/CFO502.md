...
En Física Computacional II te enseñan métodos numéricos que se implementarán en el lenguaje de programación Fortran principalmente. Los principales temas a tocar en el curso son, entre otros:
- Errores de cálculo
- Raíces de ecuaciones no lineales
- Derivación numérica
- Resolución de ecuaciones diferenciales mediante varios métodos diferentes
- Órbitas celestes
- [Modelo del caminante aleatorio](https://youtu.be/byvEzyFgv44)
- Modelo de Ising.
...
| Justo Alcides Rojas Tapia | 2022-I |
