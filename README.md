...
- Ahora:
  1. Construir una serie de canales de información en redes sociales ([Facebook](https://facebook.com/caefisica), [Instagram](https://www.instagram.com/caefisica), WhatsApp público).
  2. Prototipar y desarrollar la [versión inicial de la web](https://caefisica.com/) con documentación limitada al Plan de Estudios 2018.
  3. Compartir oportunidades y becas a través del grupo de WhatsApp público.
- Siguiente:
  1. Consolidar la información a través de grupos de WhatsApp divididos por categorías (oportunidades, artículos científicos, física de altas energías, etc).
  2. Añadir apuntes de clase en formato LaTeX transcritas de notas publicadas por profesores de la facultad. Véase [caefisica/NotasTeX](https://github.com/caefisica/NotasTeX).
  3. Implementar las partes necesarias para escalar la página web a otros planes de estudio dentro y fuera de la facultad.
