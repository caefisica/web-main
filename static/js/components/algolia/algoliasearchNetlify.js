        ...
        return (() => {
            var e = {
                    948: (e, t, r) => {
                        ...
                        var ae = "1.5.1",
                            ce = [
                                { segment: "autocomplete-core", version: ae }
                            ];
                        function le(e, t) {
                            var r = Object.keys(e);
                            if (Object.getOwnPropertySymbols) {
                        ...
                        function Oe(e) {
                            var t = [],
                                ...
                                a = ie(
                                    be({ props: r, refresh: l, store: n }, u)
                                );
                            function l() {
                                return J(
                                    be(
                                ...
                                if (
                                    ...
                                    if (null != o)
                                        for (
                                            ...
                                            f[e.attributes[p].name] =
                                                e.attributes[p].value;
                                    (s || l) &&
                                        ((s &&
                                            ((l && s.__html == l.__html) ||
                        ...
                        function Bt(e) {
                            var t = e.hit,
                                ...
                                u = Ct(
                                    t,
                                    ["_highlightResult"].concat(wt(n), [
                                        "value"
                                    ])
                                );
                            return (
                                "string" != typeof u && (u = Ct(t, n) || ""),
                                jt({ highlightedValue: u })
                            );
                        }
                        var It = {
                                "&amp;": "&",
                        ...
                        function Vt(e) {
                            var t = e.hit,
                                ...
                                u = Ct(
                                    t,
                                    ["_snippetResult"].concat(Ht(n), ["value"])
                                );
                            return (
                                "string" != typeof u && (u = Ct(t, n) || ""),
                                jt({ highlightedValue: u })
                        ...
                        function Dr(e) {
                            var t,
                                ...
                                y = {
                                    getEnvironmentProps:
                                        m.value.renderer.getEnvironmentProps,
                                    getFormProps: m.value.renderer.getFormProps,
                                    getInputProps:
                                        m.value.renderer.getInputProps,
                                    getItemProps: m.value.renderer.getItemProps,
                                    getLabelProps:
                                        m.value.renderer.getLabelProps,
                                    getListProps: m.value.renderer.getListProps,
                                    getPanelProps:
                                        m.value.renderer.getPanelProps,
                            ...
                            function O(e) {
                                ...
                                var t = {
                                    ...
                                    r =
                                        (!s(e) &&
                                            !l.current &&
                                            m.value.renderer.renderNoResults) ||
                            ...
                            function E(e) {
                                requestAnimationFrame(function () {
                                    var t =
                                        m.value.core.environment.document.body.contains(
                            ...
                            return (
                                ...
                                n(function () {
                                    ...
                                    return (
                                        ...
                                        function () {
                                            m.value.core.environment.removeEventListener(
                                                "resize",
                                                e
                                            );
                                        }
                                ...
                                n(function () {
                                    return (
                                        requestAnimationFrame(_), function () {}
                                    );
                                }),
                                vr(
                                    vr({}, g),
                    ...
                    934: function (e) {
                        ...
                        e.exports = (function () {
                            ...
                            function i(e) {
                                var t,
                                    r = "algoliasearch-client-js-".concat(
                                        e.key
                                    ),
                                    n = function () {
                                        return (
                            ...
                            function E(e) {
                                var t = {
                                    value: "Algolia for JavaScript (".concat(
                                        e,
                                        ")"
                                    ),
                                    add: function (e) {
                        ...
                        t.algoliasearchNetlify = function (e) {
                            ...
                            try {
                                for (u.s(); !(t = u.n()).done; ) {
                                    ...
                                    if (!r[l])
                                        throw new Error(
                                            "[algoliasearch-netlify] Missing mandatory key: ".concat(
                                                l
                                            )
                                        );
                                }
                    ...
                    275: (e, t, r) => {
                        ...
                        function m(e, t, r, n, i) {
                            ...
                            return (
                                null == i && null != u.vnode && u.vnode(a), a
                            );
                        }
                        function v(e) {
                            return e.children;
                                ...
                                if (
                                    ...
                                    if (null != i)
                                        for (
                                            ...
                                            m[e.attributes[y].name] =
                                                e.attributes[y].value;
                                    (f || p) &&
                                        ((f &&
                                            ((p && f.__html == p.__html) ||
                        ...
                        function I(e, t, r) {
                            ...
                            if ((n = e.__k))
                                for (o = 0; o < n.length; o++)
                                    n[o] &&
                                        I(n[o], t, "function" != typeof e.type);
                            r || null == e.__e || d(e.__e),
                                (e.__e = e.__d = void 0);
                        }
                        function k(e, t, r) {
                            return this.constructor(e, r);
