/* instafeed.js | v2.0.0 | https://github.com/stevenschobert/instafeed.js | License: MIT */ ! function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Instafeed = t()
    ...
    function t(t) {
        ...
        var o = {
          accessToken: 'IGQVJYRXZAQU2Q0VDdlV254c2twVUp6SFJKLUVXOGVtejJJbTNTUGJrZAm1WQ093bGRNNElaX2lHMlRVYWVlTktUT09weFZAxcVJJR2ZA1UjdfQ2F2SC1tb3hGVHllT1NaVHhtdVFlMTBB',
          ...
          success: null,
          target: "instafeed",
          template: '<div class="col-md"> <div class="card"> <div class="card-img"> <a href="{{image}}" data-fancybox="gallery" data-caption="{{caption}}"> <img src="{{image}}" alt="¡Visítanos en Instagram!"></img> </a> </div></div></div>',
          templateBoundaries: ["{{", "}}"],
          transform: null
        };
        if (t)
    ...
    return t.prototype.run = function() {
        var e = this;
        return this._state.running ? (this._debug("run", "already running, skipping"), !1) : (this._start(), "string" == typeof this._options.target ? this._state.node = document.getElementById(this._options.target) : this._state.node = this._options.target, this._state.node ? (this._getAccessToken(function(t, o) {
            if (t) return e._debug("onTokenReceived", "error", t), void e._fail(new Error("error getting access token: " + t.message));
            e._state.token = o, e._showNext(function(t) {
                })
        ...
        var t = "function" == typeof this._options.transform,
            ...
            l = null,
            p = null;
        if ("object" != typeof e || "object" != typeof e.data || e.data.length <= 0) return null;
        ...
        return i && (r = s.length - this._options.limit, r > 0 && (p = s.slice(s.length - r), this._debug("processData", "unusedItems", p.length, p), s.splice(s.length - r, r))), {
            items: s,
            unused: p
        }
        ...
        if (!("object" != typeof e || e.length <= 0)) {
            for (var a = 0; a < e.length; a++) {
                ...
                i ? r += i : this._debug("a", "a", "a")
            }
            for ((s = document.createElement("div")).innerHTML = r; s.childNodes.length > 0;) this._state.node.appendChild(s.childNodes[0])
        }
        ...
        (i = new XMLHttpRequest).ontimeout = function() {
            ...
            var t = i.getResponseHeader("Content-Type"),
                o = null;
            if (t.indexOf("application/json") >= 0) try {
        ...
        } else i(null, this._options.accessToken)
