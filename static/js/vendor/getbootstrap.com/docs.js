!(function (a, b) {
    ...
    (function () {
        ...
        document.querySelectorAll(".tooltip-demo").forEach(function (a) {
            ...
            a &&
                document
                    ...
                    .addEventListener("change", function () {
                        a.dataset.originalClass ||
                            (a.dataset.originalClass = a.className),
                            (a.className =
                                a.dataset.originalClass + " " + this.value);
                    }),
            document
                .querySelectorAll(".bd-example .toast")
                .forEach(function (a) {
            ...
            document
                .querySelectorAll('.bd-content [href="#"]')
                .forEach(function (a) {
